...
char *vty_read(vty_t *vty)
{
    ...
    while (n > 0)
    {
        ...
        //printf("vty.c: read char: %s (int: %d)\n", ch, (int)*ch);
...
{
    vty->saved_cursor_pos = vty->cursor_pos;
}
