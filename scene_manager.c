...
void    scene_manager_on_vdev_event_new(event_pump_t* pump, int event_id, void* data, void* context);
void    scene_manager_on_sensor_event_new(event_pump_t* pump, int event_id, void* data, void* context);
void    scene_manager_on_scene_activation_event_new(event_pump_t* pump, int event_id, void* data, void* context);
...
void scene_manager_init()
{
    ...
    event_dispatcher_register_handler(pump, VdevDataChangeEvent, scene_manager_on_vdev_event_new, NULL);
    event_dispatcher_register_handler(pump, SensorDataChangeEvent, scene_manager_on_sensor_event_new, NULL);
    event_dispatcher_register_handler(pump, SceneActivationEvent, scene_manager_on_scene_activation_event_new, NULL);
...
void    scene_manager_on_vdev_event_new(event_pump_t* pump, int event_id, void* data, void* context)
{
    ...
    vdev_event_data_t* event_data = VARIANT_GET_PTR(vdev_event_data_t, event->data);
    vdev_t* vdev = vdev_manager_get_vdev_by_id(event_data->vdev_id);
